...
(2, '2025-09-08', 'Recolección en Sur - Febres Cordero'),
(2, '2025-09-15', 'Recolección en Sur - Febres Cordero'),
(6, '2025-09-22', 'Quito - Chillogallo');
...
(7, 2, (SELECT id_proceso_disposicion FROM proceso_disposicion WHERE nombre='Reciclaje'),   75.00), -- Plástico
(8, 2, (SELECT id_proceso_disposicion FROM proceso_disposicion WHERE nombre='Reciclaje'),   75.00), -- Plástico
(9, 4, (SELECT id_proceso_disposicion FROM proceso_disposicion WHERE nombre='Incineración'),15.00); -- Baterías
